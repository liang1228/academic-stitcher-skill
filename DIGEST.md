...
## 2. Read papers according to the decision they must support
...
## 3. Let A/B/C move with the claim boundary
...
## 4. Transfer modules through contracts, not names
...
## 5. Separate innovation from workload
...
3. Keep innovation, workload, evidence state, and current formal requirements in separate ledgers.
